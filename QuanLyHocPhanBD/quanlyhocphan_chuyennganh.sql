...
CREATE TABLE `chuyennganh` (
  ...
  KEY `FK__ChuyenNga__MaKho__7755B73D` (`MaKhoa`),
  CONSTRAINT `FK__ChuyenNga__MaKho__7755B73D` FOREIGN KEY (`MaKhoa`) REFERENCES `khoa` (`MaKhoa`)
...
INSERT INTO `chuyennganh` VALUES ('cncnpm','Công nghệ phần mềm','KhoaHTTT'),('httt','Hệ thống thông tin','KhoaHTTT'),('vt','Viễn thám','KhoaHTTT');
