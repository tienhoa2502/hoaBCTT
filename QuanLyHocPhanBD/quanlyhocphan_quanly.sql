...
CREATE TABLE `quanly` (
  ...
  PRIMARY KEY (`MaQL`),
  KEY `FK__QuanLy__TaiKhoan__0B5CAFEA` (`TaiKhoan`),
  CONSTRAINT `FK__QuanLy__TaiKhoan__0B5CAFEA` FOREIGN KEY (`TaiKhoan`) REFERENCES `accounts` (`TaiKhoan`)
...
INSERT INTO `quanly` VALUES ('ql01','Admin','Nguyễn','admin123@gmail.com','12341234','1234512345','0850080012@admin.hcmunre.edu.vn',1,'HCM','admin');
